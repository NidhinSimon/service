...
const EmpConversation = ({ data, currentUser, notification }) => {
  const [userData, setuserData] = useState(null);

  console.log(notification, "nototototototototot");
  useEffect(() => {
    ...
    <div>
      <div className="bg-slate-300  rounded-md hover:bg-slate-200">
        <Avatar className="h-16" img={userData?.profileimage} rounded-md>
          {notification && <p className="text-green-500 text-2xl">*</p>}
...
export default EmpConversation;
